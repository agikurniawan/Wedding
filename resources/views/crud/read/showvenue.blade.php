...
<div class="section">
	...
	<div class="row">
		<div class="col s12">
            <br><h5>{{ $venue->harga }}</h5>
            <img src="{{ asset('images/'.$venue->gambar)  }}" style="max-height:200px;max-width:200px;margin-top:10px;">

            
            <a href="{{url('readvenue', $venue->id)}}" class="btn btn-flat pink accent-3 waves-effect waves-light white-text">Readmore <i class="material-icons right">send</i></a>
